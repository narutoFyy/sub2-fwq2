export default {
  ...
  modelRadar: {
    title: 'Reset Radar',
    subtitle: 'Observe reasoning and SVG animation output by OpenAI group.',
    groupTests: 'Group intelligence tests',
    logic: 'Logic reasoning test',
    drawing: 'SVG animation test',
    model: 'Model',
    effort: 'Reasoning effort',
    enabled: 'Automatic checks',
    passed: 'Passed',
    failed: 'Failed',
    ...
    question: 'Prompt',
    result: 'Result',
    rawOutput: 'View raw model output',
    previewUnavailable: 'The model returned no displayable content',
    noData: 'No data',
    latency: '{ms} ms',
    nextRun: 'Next check: {time}',
    lastRun: 'Last check: {time}',
    interval: 'Every {minutes} minutes',
    iq: 'Intelligence efficiency',
    recommendation: 'Site recommendation',
    notDeveloped: 'Not developed',
    refresh: 'Refresh results',
    configure: 'Configure radar',
    runNow: 'Run now',
    save: 'Save configuration',
    review: 'Review SVG',
    reviewPass: 'Approve',
    reviewFail: 'Reject',
    empty: 'No OpenAI groups are available.',
    saved: 'Radar configuration saved',
    running: 'Checks started',
    loadFailed: 'Failed to load radar data'
  },
