    ...
    h(
      ...
      [
        h('path', {
          'stroke-linecap': 'round',
          'stroke-linejoin': 'round',
          d: 'M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.076-4.076a1.526 1.526 0 011.037-.443 48.084 48.084 0 005.85-.402c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z'
        })
      ]
    )
}
...
const RadarIcon = {
  render: () => h('svg', { fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor', 'stroke-width': '1.5' }, [
    ...
    h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', d: 'M12 12l5.25-5.25M12 3.75v2.25M3.75 12H6' }),
    h('circle', { cx: '12', cy: '12', r: '1.25', fill: 'currentColor', stroke: 'none' })
  ])
}
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/reset-radar', label: t('nav.resetRadar'), icon: RadarIcon },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/model-radar', label: t('nav.resetRadar'), icon: RadarIcon },
